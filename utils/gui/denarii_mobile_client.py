...
class DenariiMobileClient:
    ...
    def send_denarii_mobile_request(self, method, params):
        return self.send_request(self.denarii_mobile_users_endpoint, "10003", method, params)
    ...
    def poll_for_completed_transaction(self, user_id):
        ...
        res, ok = self.send_denarii_mobile_request('poll_for_completed_transaction', params)
