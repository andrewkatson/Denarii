...
class SetWalletScreen(Screen):
    ...
    def setup(self):
        ...
        self.first_horizontal_layout.addWidget(
            self.set_wallet_label, alignment=Qt.AlignCenter
        )
        ...
        self.second_horizontal_layout.addWidget(
            self.set_wallet_text_box, alignment=Qt.AlignCenter
        )
        self.third_horizontal_layout.addWidget(
            self.set_wallet_submit_push_button, alignment=Qt.AlignCenter
        )
