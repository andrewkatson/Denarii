...
class Widget:
    ...
    def addWidget(self, new_widget, row=None, col=None, alignment=None):
...
class CommentSection(Widget):
    ...
    def addComment(self, author, body, updated_time):
        ...
        self.comments[f"{author}@{updated_time}"] = {"author": author, "body": body, "author_label": author_label,
                                                     "body_label": body_label}

        self.layout.addWidget(author_label, alignment=AlignLeft)
